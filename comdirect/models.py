...
# Modelo para Configurações Gerais da comdirect
class Config(models.Model):
    ...
    class Meta:
        verbose_name = "Configuração da comdirect"
        verbose_name_plural = "Configurações da comdirect"

    def __str__(self):
        return "Configurações da comdirect comdirect"
...
# Modelo para Detalhes Bancários da comdirect
class PlatformBankDetails(models.Model):
    ...
    class Meta:
        verbose_name = "Detalhe Bancário da comdirect"
        verbose_name_plural = "Detalhes Bancários da comdirect"
...
class Sobre(models.Model):
    ...
    def __str__(self):
        return "Conteúdo da Página 'Sobre' da comdirect"
