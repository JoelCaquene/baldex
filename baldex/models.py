...
# Modelo para Configurações Gerais da baldex
class Config(models.Model):
    ...
    class Meta:
        verbose_name = "Configuração da baldex"
        verbose_name_plural = "Configurações da baldex"

    def __str__(self):
        return "Configurações da baldex baldex"
...
# Modelo para Detalhes Bancários da baldex
class PlatformBankDetails(models.Model):
    ...
    class Meta:
        verbose_name = "Detalhe Bancário da baldex"
        verbose_name_plural = "Detalhes Bancários da baldex"
...
class Sobre(models.Model):
    ...
    def __str__(self):
        return "Conteúdo da Página 'Sobre' da baldex"
